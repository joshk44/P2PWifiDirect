...
class WiFiDirectBroadcastReceiver(private val manager: WifiP2pManager?, private val channel: WifiP2pManager.Channel,
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (WifiP2pManager.WIFI_P2P_STATE_CHANGED_ACTION == action) {
            ...
            manager?.requestPeers(channel, activity.supportFragmentManager.findFragmentByTag("frag_list") as PeerListListener)
            ...
            if (networkInfo.isConnected) {
                ...
                val fragment = activity.supportFragmentManager.findFragmentByTag("frag_detail") as DeviceDetailFragment
            ...
            val fragment = activity.supportFragmentManager.findFragmentByTag("frag_list") as DeviceListFragment
